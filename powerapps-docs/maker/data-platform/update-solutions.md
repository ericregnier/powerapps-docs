...
The option to overwrite customizations is only available with the classic import experience, using the SDK APIs and using the the [Power Platform Build Tools](/power-platform/alm/devops-build-tool-tasks).
